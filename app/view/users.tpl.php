		...
		<table class="table table-striped table-bordered table-hover marginTop">
			...
			<tbody>
				...
				<tr>
					...
					<td><?=$user["nome"]?></td>
					<td>
						<a href="index.php?m=alterarUsuario&id=<?=$usuario["usuarioid"]?>" class="btn btn-primary">Alterar</a>
					</td>
					<td>
						<a href="index.php?m=excluirUsuario&id=<?=$usuario["usuarioid"]?>" class="btn btn-danger" onclick="return confirm('Deseja realmente excluir o registro?')">Excluir</a>
					</td>
				</tr>
